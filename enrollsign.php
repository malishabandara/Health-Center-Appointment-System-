...
<head>
    ...
    <link rel ="stylesheet" href="./css/enrollment/enrollment.css?=<?php echo time() ?>">
                    ...
                    <form action="includes/enrollmentformhandler.php" method="POST">
                        <div class="form_container">
                            <div class="input_wrap">
                                <label for="form1_input1">Registration Number</label>
                                <input type="text" id="form1_input1" name="regNo" value="" required >
                            </div>
                            <div class="input_wrap">
                                <label for="form1_input2">Faculty</label>
                                <input type="text" id="form1_input2" name="faculty" value="" required>
                            </div>
                        </div>
                ...
                <div class="form_4 data_info" >
                        ...
                        <div class="form_container">
                            ...
                            <div class="input_wrap">
                                ...
                                <input type="number" value="" name="height" id="form4_input2" required >
                            </div>
                            <div class="input_wrap">
                                <label for="form4_input3">Weight</label>
                                <input type="number" name="weight" value="" id="form4_input3" required >
                            </div>
                            <div class="input_wrap">
